...
try {
    $documento = emitirDocumento($id, (int) Rbac::userId());

    echo json_encode([
        'status' => 'success',
        'data' => ['documento' => $documento],
        'message' => 'Documento emitido y firmado.',
        'mensaje' => 'Documento emitido y firmado.',
    ], JSON_UNESCAPED_UNICODE);
    ...
    echo json_encode([
        'status' => 'error',
        'data' => [],
        'message' => 'No fue posible emitir el documento.',
        'mensaje' => 'No fue posible emitir el documento.',
    ], JSON_UNESCAPED_UNICODE);
}
